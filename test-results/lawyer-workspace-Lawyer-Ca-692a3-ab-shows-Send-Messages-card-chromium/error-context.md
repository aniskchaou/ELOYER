...
- Name: lawyer-workspace.spec.js >> Lawyer Case Workspace — Client Communication tab >> shows Send Messages card
- Location: tests\e2e\lawyer-workspace.spec.js:227:3
